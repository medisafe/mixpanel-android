...
/* package */ class ConfigurationChecker {
    ...
    public static boolean checkBasicConfiguration(Context context) {
        ...
        if (packageManager == null || packageName == null) {
            MPLLog.w(LOGTAG, "Can't check configuration when using a Context with null " +
                    "packageManager or packageName");
            return false;
        }
        if (PackageManager.PERMISSION_GRANTED != packageManager.checkPermission("android.permission.INTERNET", packageName)) {
            MPLLog.w(LOGTAG, "Package does not have permission android.permission.INTERNET - " +
                    "Mixpanel will not work at all!");
            MPLLog.i(LOGTAG, "You can fix this by adding the following to your AndroidManifest.xml file:\n" +
    ...
    public static boolean checkPushConfiguration(Context context) {
        ...
        if (packageManager == null || packageName == null) {
            MPLLog.w(LOGTAG, "Can't check configuration when using a Context with null packageManager or packageName");
            return false;
        }
        ...
        try {
            ...
            MPLLog.w(LOGTAG, "Application does not define permission " + permissionName);
            MPLLog.i(LOGTAG, "You will need to add the following lines to your application manifest:\n" +
        ...
        if (PackageManager.PERMISSION_GRANTED != packageManager.checkPermission("com.google.android.c2dm.permission.RECEIVE", packageName)) {
            MPLLog.w(LOGTAG, "Package does not have permission com.google.android.c2dm.permission" +
                    ".RECEIVE");
            MPLLog.i(LOGTAG, "You can fix this by adding the following to your AndroidManifest.xml file:\n" +
        ...
        if (PackageManager.PERMISSION_GRANTED != packageManager.checkPermission("android" +
        ...
        if (PackageManager.PERMISSION_GRANTED != packageManager.checkPermission("android" +
                ".permission.WAKE_LOCK", packageName)) {
            MPLLog.w(LOGTAG, "Package does not have permission android.permission.WAKE_LOCK");
            MPLLog.i(LOGTAG, "You can fix this by adding the following to your AndroidManifest.xml file:\n" +
        ...
        if (PackageManager.PERMISSION_GRANTED != packageManager.checkPermission("android" +
                ".permission.GET_ACCOUNTS", packageName)) {
            MPLLog.i(LOGTAG, "Package does not have permission android.permission.GET_ACCOUNTS");
            MPLLog.i(LOGTAG, "Android versions below 4.1 require GET_ACCOUNTS to receive Mixpanel push notifications.\n" +
        ...
        try {
            ...
            MPLLog.w(LOGTAG, "Could not get receivers for package " + packageName);
            return false;
        }
        ...
        try {
            ...
            MPLLog.w(LOGTAG, "Google Play Services aren't included in your build- push " +
                    "notifications won't work on Lollipop/API 21 or greater");
            MPLLog.i(LOGTAG, "You can fix this by adding com.google.android.gms:play-services as a dependency of your gradle or maven project");
        }
